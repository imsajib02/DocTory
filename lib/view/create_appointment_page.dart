...
class CreateAppointmentPage extends StatefulWidget {
  ...
  final CreateAppointmentRouteParameter _parameter;

  CreateAppointmentPage(this._parameter);

  @override
  _CreateAppointmentPageState createState() => _CreateAppointmentPageState();
}

class _CreateAppointmentPageState extends State<CreateAppointmentPage> with WidgetsBindingObserver implements View {
  ...
  void initState() {
    ...
    _presenter = CreateAppointmentPresenter(this, widget._parameter.appointmentList, widget._parameter.patientList);
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          elevation: 2,
          centerTitle: true,
          title: Text(AppLocalization.of(context).getTranslatedValue("create_a_new_appointment"),
  ...
  void onEntryFailure(BuildContext context) {
    ...
    hideProgressDialog();
    _myWidget.showSnackBar(context, AppLocalization.of(context).getTranslatedValue("failed_to_create_appointment_text"),
        Colors.red, 3);
  }
  ...
  Future<void> onEntrySuccess(BuildContext context) async {
    ...
    _myWidget.showSnackBar(context, AppLocalization.of(context).getTranslatedValue("appointment_successfully_created_text"),
        Colors.green, 3);
  }
  ...
  @override
  Future<void> backToAppointmentDashboard() async {
