...
import 'package:doctory/presenter/edit_prescription_presenter.dart';
...
class EditPrescriptionPage extends StatefulWidget {
  ...
  final EditPrescriptionRouteParameter _parameter;

  EditPrescriptionPage(this._parameter);

  @override
  _EditPrescriptionPageState createState() => _EditPrescriptionPageState();
}

class _EditPrescriptionPageState extends State<EditPrescriptionPage> with WidgetsBindingObserver implements View {
  ...
  void initState() {
    ...
    _presenter = EditPrescriptionPresenter(this, widget._parameter.prescription, widget._parameter.prescriptionList);
    ...
    _investigationList = List();

    _followUpDateController.text = widget._parameter.prescription.followUpDate;
    _visitingFeeController.text = widget._parameter.prescription.income.visitingFee.toString();
    _chamberNameController.text = widget._parameter.prescription.chamber.name;
    _prescription.chamber = widget._parameter.prescription.chamber;
    _prescription.chamberID = widget._parameter.prescription.chamberID;
    _patientNameController.text = widget._parameter.prescription.patient.name;
    _ageController.text = widget._parameter.prescription.patient.age;
    _mobileController.text = widget._parameter.prescription.patient.mobile;
    _addressController.text = widget._parameter.prescription.patient.address;
    _historyController.text = widget._parameter.prescription.history;
    _prescription.patient = widget._parameter.prescription.patient;
    _prescription.patientID = widget._parameter.prescription.patientID;
    _prescription.income = widget._parameter.prescription.income;
    _prescription.incomeID = widget._parameter.prescription.incomeID;

    widget._parameter.prescription.prescriptionMedicineList.forEach((item) {

      _prescriptionMedicineList.add(item);
    });

    widget._parameter.prescription.investigations.forEach((item) {

      _investigationList.add(item);
    });
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          elevation: 2,
          centerTitle: true,
          title: Text(AppLocalization.of(context).getTranslatedValue("update_prescription_info"),
                      ...
                      children: <Widget>[
                        ...
                        Flexible(
                          child: Container(
                            ...
                            child: Wrap(
                              children: _investigationList.map((item) => Container(
                                      ...
                                      Expanded(
                                        ...
                                        child: Container(
                                          ...
                                          child: TextField(
                                            ...
                                            decoration: InputDecoration(
                                              hintText: AppLocalization.of(context).getTranslatedValue("result"),
                                              hintStyle: Theme.of(context).textTheme.subhead,
                                              border: OutlineInputBorder(
                                      ...
                                      Expanded(
                                        ...
                                        child: Container(
                                          ...
                                          decoration: BoxDecoration(
                                            ...
                                            borderRadius: BorderRadius.only(topRight: Radius.circular(1.00009 * SizeConfig.heightSizeMultiplier),
                                                bottomRight: Radius.circular(1.00009 * SizeConfig.heightSizeMultiplier))
                                          ),
                          ...
                          child: BounceAnimation(
                            ...
                            childWidget: RaisedButton(
                              ...
                              onPressed: () {
                                ...
                                _prescription.investigations = _investigationList;
  ...
  void _removeTopic(Investigation item) {
    ...
    for(int i=0; i<_investigationList.length; i++) {

      if(_investigationList[i].id == item.id) {

        setState(() {
          _investigationList.removeAt(i);
        });
            ...
            child: StatefulBuilder(
              builder: (BuildContext context, StateSetter setState) {
                ...
                return Container(
                  ...
                  alignment: Alignment.center,
                  height: 65 * SizeConfig.heightSizeMultiplier,
                  decoration: BoxDecoration(),
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    mainAxisAlignment: MainAxisAlignment.center,
  ...
  void onUpdateFailure(BuildContext context) {
    ...
    hideProgressDialog();
    _myWidget.showSnackBar(context, AppLocalization.of(context).getTranslatedValue("failed_to_update_prescription_info"),
        Colors.red, 3);
  }
  ...
  Future<void> onUpdateSuccess(BuildContext context) async {
    ...
    hideProgressDialog();
    _myWidget.showSnackBar(_scaffoldContext, AppLocalization.of(context).getTranslatedValue("successfully_updated_prescription"), Colors.green, 3);
  }
